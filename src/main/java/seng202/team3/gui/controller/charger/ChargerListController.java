...
public class ChargerListController {
    ...
    private static final int LIST_WRAPPER = 275;

    /** smaller view wrapper */
    private static final int SMALLER_VIEW_WRAPPER = 220;
    ...
    private void loadLargerChargerView(Charger c) {
        ...
        chargerName.setWrappingWidth(LARGER_VIEW_WRAPPER);
        ...
        distance.setWrappingWidth(LARGER_VIEW_WRAPPER);
        ...
        chargerAddress.setWrappingWidth(LARGER_VIEW_WRAPPER);
        ...
        parking.setWrappingWidth(LIST_WRAPPER);
        largeDisplayInfo.getChildren().add(parking);

        for (Text t : getMainText(c)) {
            t.setWrappingWidth(LARGER_VIEW_WRAPPER);
    ...
    private void addConnectorsToView(Charger c) {
        for (Connector con : c.getConnectors()) {
            ...
            type.setWrappingWidth(LARGER_VIEW_WRAPPER);
            Text count = new Text("Number of connectors: " + con.getCount() + "");
            count.setWrappingWidth(LARGER_VIEW_WRAPPER);
            Text current = new Text("Current: " + con.getCurrent() + "");
            current.setWrappingWidth(LARGER_VIEW_WRAPPER);
            Text power = new Text("Power Type: " + con.getPower() + "");
            power.setWrappingWidth(LARGER_VIEW_WRAPPER);
            Text status = new Text("Status: " + con.getStatus() + "");
            status.setWrappingWidth(LARGER_VIEW_WRAPPER);
